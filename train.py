...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/waste.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='runs/train/waste', help='save to project/name')
