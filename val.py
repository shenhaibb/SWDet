...
def run(
    ...
    if len(stats) and stats[0].any():
        ...
        LOGGER.info(f'AP[.5:.95]: {ap.mean(0)}')
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/TACO.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/TACO/yolov5s/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='runs/val/TACO', help='save to project/name')
