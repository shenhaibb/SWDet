...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            # self.lw = 7  # swad
            # self.lw = 7  # swad-grad
            cv2.rectangle(self.im, p1, p2, color, thickness=25, lineType=cv2.LINE_AA)
            # cv2.rectangle(self.im, p1, p2, color, thickness=15, lineType=cv2.LINE_AA)
            # cv2.rectangle(self.im, p1, p2, color, thickness=8, lineType=cv2.LINE_AA)
            if label:
                tf = 20  # font thickness
